...
class QuillComponent extends React.Component {
  ...
  getEditorConfig() {
    var formats = this.props.formats || ['bold', 'italic', 'link'];
    var config = {
...
//   window.Kattappa.Component = window.Kattappa.Component || {};
//   window.Kattappa.Component.QuillComponent = QuillComponent;
// }
